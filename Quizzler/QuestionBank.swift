...
// ESSA PARTE EH PARA COLOCAR AS PERGUNTAS DO APP

import Foundation

class QuestionBank {
    //dentro os colchetes sao os arrays
    //quando variaveis e constantes sao criadas dentro das chaves sao as propertys que contem todos os dados que serao usados no app
    
    var list = [Question]()
    
    // para completar o que estiver dentro dos arrays, usa-se o init
    //nesse caso nao teremos parametros, nao iremos alimentar dados
    init(){
        //colocar as questoes
        
        //O APPEND QUE APARECE NO CODIGO SERVE PARA ALIMENTAR O QUE ESTIVER DENTRO DO ARRAY
